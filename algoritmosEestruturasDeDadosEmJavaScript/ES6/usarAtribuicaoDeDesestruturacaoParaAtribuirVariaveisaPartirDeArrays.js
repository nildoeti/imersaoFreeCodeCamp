...
// console.log(m, n, p); // 11 22 77


/*
	Use atribuição de desestruturação para trocar os valores de a e b para que 
	a receba os valores armazenados em b e b recebe os valores armazenados em a.
*/
