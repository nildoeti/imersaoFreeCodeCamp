/*
	...
	Uma forma fácil de adicionar dados no final de um array é através da 
	função push().
	...
	arr1 agora tem o valor de [1, 2, 3, 4] e arr2 tem o valor de 
...
console.log(myArray); // [ [ 'John', 23 ], [ 'cat, 2' ], [ 'dog', 3 ], [ 'pet', 4 ] ]
